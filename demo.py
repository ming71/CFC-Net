...
from models.CFCNet import CFCNet
...
#     os.mkdir('outputs')
    ...
    ## DOTA detct on large image
        ...
        evaluate(args.target_size,
                args.ims_dir,    # 注意是整张图的root目录，但是同级目录需要有提前分割好的split root目录,否则无法evaluate
                'DOTA',
                args.backbone,
                args.weight,
                hyps = hyps,
...
#     parser.add_argument('--ims_dir', type=str, default='NWPU_VHR/AllImages')   
