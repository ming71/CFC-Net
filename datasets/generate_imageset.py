...
def generate_iamgets(dataset=None):
    ...
    # voc格式的有imageset file
        ...
        trainset = r'/py/datasets/HRSC2016/ImageSets/train.txt'
        valset   = r'/py/datasets/HRSC2016/ImageSets/test.txt'
        testset   = r'/py/datasets/HRSC2016/ImageSets/test.txt'
        img_dir = r'/py/datasets/HRSC2016/FullDataSet/AllImages'
        label_dir = r'/py/datasets/HRSC2016/FullDataSet/Annotations'
        root_dir = r'/py/datasets/HRSC2016/FullDataSet' 
